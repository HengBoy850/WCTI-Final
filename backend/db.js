...
// Only enable SSL when DB_SSL=true is set (e.g. on Render, pointing at
// TiDB Cloud). Locally against XAMPP, DB_SSL is unset, so this stays
// undefined and mysql2 connects exactly as before with no SSL.
